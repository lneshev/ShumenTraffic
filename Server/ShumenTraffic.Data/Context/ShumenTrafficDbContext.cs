...
namespace ShumenTraffic.Data.Context
{
    /// <summary>
    ...
    /// </summary>
    public class ShumenTrafficDbContext : IdentityDbContext<IdentityUser, IdentityRole, string>
    {
        /// <summary>
        /// Initializes a new instance of the ShumenTrafficDbContext class.
        /// </summary>
        public ShumenTrafficDbContext(DbContextOptions<ShumenTrafficDbContext> options)
            : base(options)
        {
        }
