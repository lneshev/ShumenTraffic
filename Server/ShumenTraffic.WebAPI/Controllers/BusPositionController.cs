...
namespace ShumenTraffic.WebAPI.Controllers
{
    ...
    public class BusPositionController : BaseController
    {
        ...
        public BusPositionController(ShumenTrafficDbContext context)
        {
            _context = context;
        }
        ...
        /// </summary>
        private async Task<BusPositionDto> CalculatePositionFromSchedule(Data.Models.Route route, string busId, TimeSpan currentTime)
        {
