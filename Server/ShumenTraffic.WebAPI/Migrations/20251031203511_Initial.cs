...
namespace ShumenTraffic.WebAPI.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TransportationCompanyBusLines",
                columns: table => new
                {
                    TransportationCompanyId = table.Column<int>(type: "int", nullable: false),
                    BusLineId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportationCompanyBusLines", x => new { x.TransportationCompanyId, x.BusLineId });
                    table.ForeignKey(
                        name: "FK_TransportationCompanyBusLines_BusLines_BusLineId",
                        column: x => x.BusLineId,
                        principalTable: "BusLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransportationCompanyBusLines_TransportationCompanies_TransportationCompanyId",
                        column: x => x.TransportationCompanyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleCourses_Routes_RouteId",
                        column: x => x.RouteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleCourses_RouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportationCompanies_Name",
                table: "TransportationCompanies",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TransportationCompanyBusLines_BusLineId",
                table: "TransportationCompanyBusLines",
                column: "BusLineId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationCompanyBusLines_TransportationCompanyId",
                table: "TransportationCompanyBusLines",
